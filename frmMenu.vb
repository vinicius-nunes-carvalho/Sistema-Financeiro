...
Public Class frmMenu
    ...
    Private Sub dgvDados_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvDados.CellContentClick
        ...
        If row.Cells("Categoria").Value.ToString = "" Then
            MsgBox("A linha selecionada já está vazia!", MsgBoxStyle.Information, "Aviso")
            Exit Sub
        Else
    ...
    Private Sub FormaPagamentoToolStripMenuItem_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub CategotiaToolStripMenuItem_Click(sender As Object, e As EventArgs)
        filtroCategoria()
    End Sub
